...
export const siteConfig: SiteConfig = {
	...
	// 站点副标题
	subtitle: "volatile's blog",

	// 站点 URL
	site_url: "https://volatile.qzz.io",
	...
	favicon: [
		{
			// 图标文件路径
			src: "https://cdn.luogu.com.cn/upload/image_hosting/690g6uk9.png",
			// 可选，指定主题 'light' | 'dark'
			// theme: "light",
			// 可选，图标大小
			// sizes: "32x32",
	...
	navbar: {
		...
		logo: {
			type: "url",
			value: "https://cdn.luogu.com.cn/upload/image_hosting/690g6uk9.png",
			alt: "Logo",
		},
		// 导航栏标题
		title: "volatile",
